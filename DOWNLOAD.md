...
The full ISO build and package consistency checks passed. A complete VM installation and first boot are still untested; see [BUILD-VERIFICATION.md](BUILD-VERIFICATION.md). This is an independent build, not an official Kali release.
